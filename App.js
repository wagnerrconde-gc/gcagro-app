...
const fbListen = (path, cb) => db.ref(path).on('value', s => cb(s.exists() ? s.val() : null));

// Migra dados salvos: divide a categoria antiga "Sementes / TS" em
// "Sementes" (produtos com 'sement' no nome) e "Tratamento de Sementes" (o resto).
// Também apaga ingrediente_ativo de categorias que não são Herbicidas/Fungicidas/Inseticidas/Dessecação.
const migrateCats = (data) => {
  if (!data || typeof data !== "object") return data;
  const defCats = ["Herbicidas","Fungicidas","Inseticidas","Dessecação"];
  const out = {};
  for (const cult in data) {
    const c = data[cult];
    if (c && Array.isArray(c.categories)) {
      const cats = [];
      for (const cat of c.categories) {
        let newCat = { ...cat };
        // Dividir "Sementes / TS" antiga
        if (cat && cat.name === "Sementes / TS") {
          const prods = cat.products || [];
          const sem = prods.filter(p => (p.produto||"").toLowerCase().includes("sement"));
          const trat = prods.filter(p => !(p.produto||"").toLowerCase().includes("sement"));
          cats.push({ name: "Sementes", products: sem });
          cats.push({ name: "Tratamento de Sementes", products: trat });
          continue;
        }
        // Apagar I.A. em categorias que não são defensivas
        if (cat && !defCats.includes(cat.name) && cat.products) {
          newCat.products = cat.products.map(p => ({...p, ingrediente_ativo:""}));
        }
        cats.push(newCat);
      }
      out[cult] = { ...c, categories: cats };
    } else {
      out[cult] = c;
    }
  }
...
const BG_IMAGE = "url('data:image/jpeg;base64,')";
...
const CAT_ICONS = {
  "Adubação":"🌱","Sementes":"🌾","Tratamento de Sementes":"💧","Sementes / TS":"🌾","Kit Sulco":"🪱",
...
const INITIAL_DATA_VERAO = {
  Soja: {
    ...
    categories: [
      ...
      { name:"Tratamento de Sementes", products:[
        { produto:"Endofuse", dose:0.03, area:957, fase:"", obs:"", preco_unit:7550, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"Fungos micorrízicos", revenda:"Valoriza", vencimento:"30/09/2025" },
        { produto:"Auras", dose:0.2, area:957, fase:"", obs:"", preco_unit:430, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"Fluopiram", revenda:"Terrena", vencimento:"30/04/2026" },
        { produto:"Raiz F Plus", dose:0.2, area:957, fase:"", obs:"850 hectares", preco_unit:420, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"", revenda:"Germinar", vencimento:"30/04/2026" },
        { produto:"Aveo", dose:0.02, area:840, fase:"", obs:"EXCETO B5830", preco_unit:5500, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"Bacillus amyloliquefaciens", revenda:"Valoriza", vencimento:"30/04/2026" },
      ]},
  ...
  Feijão: {
    ...
    categories: [
      ...
      { name:"Tratamento de Sementes", products:[
        ...
        { produto:"Endofuse", dose:0.02, area:136.5, fase:"Plantio", obs:"", preco_unit:7550, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"Fungos micorrízicos", revenda:"Valoriza", vencimento:"30/09/2025" },
        ...
        { produto:"Aveo", dose:0.01, area:136.5, fase:"Plantio", obs:"", preco_unit:5500, preco_compra:null, fornecedor_compra:null, ingrediente_ativo:"Bacillus amyloliquefaciens", revenda:"Valoriza", vencimento:"30/04/2026" },
      ]},
      { name:"Kit Sulco", products:[
  ...
  <div style={{display:"flex",gap:8}}>
          <button onClick={()=>{
            ...
            let html = `<html><head><meta charset='utf-8'><style>
              ...
              h1{background:#1a5c2e;color:#fff;padding:8px 14px;border-radius:4px;font-size:16px;}
              h2{color:#1a5c2e;font-size:13px;margin:18px 0 4px;}
              ul{margin:4px 0 10px 20px;}
              li{font-size:12px;line-height:1.8;}
              .obs{font-size:11px;color:#666;}
              hr{border:none;border-top:1px solid #ddd;margin:12px 0;}
            </style></head><body>
            <h1 style='text-align:center'>GC Agro — Tratamento de Sementes e Kit Sulco (dose/ha)</h1>`;
            ...
            a.href=url; a.download="TS_KitSulco_GCAgro.doc"; a.click(); URL.revokeObjectURL(url);
          }} style={{padding:"7px 14px",background:"#1565C0",border:"none",borderRadius:6,color:"#fff",fontSize:12,fontWeight:700,cursor:"pointer"}}>📄 Exportar Word</button>
      ...
      {filtradas.length>0&&(
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:10,marginBottom:14}}>
          {Object.entries(byCultura).map(([cult,rows])=>{
            ...
            const totalProd=rows.reduce((s,r)=>s+(r.producao||0),0);
            const media=totalArea>0?totalProd/totalArea:0;
            const cc=CULT_COLORS[cult]||{bg:"#37474f",light:"#f5f5f5",accent:"#546e7a",badge:"#78909c"};
            const best=rows.reduce((b,r)=>r.area>0&&(r.producao/r.area)>(b.producao/b.area)?r:b,rows[0]);
            return(
              <div key={cult} style={{background:"#fff",borderRadius:10,overflow:"hidden",boxShadow:"0 1px 4px rgba(0,0,0,0.08)"}}>
                <div style={{background:cc.bg,color:"#fff",padding:"8px 12px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                  <div style={{fontWeight:700,fontSize:12}}>{cult}</div>
                  <div style={{fontSize:10,opacity:0.8}}>{rows.length} talhões</div>
                </div>
                <div style={{padding:"10px 12px"}}>
                  <div style={{fontSize:22,fontWeight:800,color:cc.bg,marginBottom:2}}>{fmtNum(media)} <span style={{fontSize:11,fontWeight:400,color:"#888"}}>sc/ha</span></div>
                  <div style={{fontSize:10,color:"#888",marginBottom:6}}>Média geral</div>
                  <div style={{display:"flex",justifyContent:"space-between",fontSize:10,color:"#666"}}>
                    <span>Total: {totalProd.toLocaleString("pt-BR")} sc</span>
                    <span>{fmtNum(totalArea)} ha</span>
                  </div>
                  {best&&best.area>0&&<div style={{marginTop:6,fontSize:10,background:cc.light,padding:"4px 8px",borderRadius:5,color:cc.accent}}>🏆 {best.lote}: {fmtNum(best.producao/best.area)} sc/ha</div>}
                </div>
              </div>
            );
          })}
...
function ProgView({data, setData, tipo, onGerarCotacao}) {
  ...
  const [editingKgSem, setEditingKgSem] = useState(false);
  ...
  function updField(catIdx,prodIdx,field,value) {
    setData(d=>{ const nd=JSON.parse(JSON.stringify(d)); const p=nd[activeCult].categories[catIdx].products[prodIdx];
      p[field]=["produto","fase","obs","revenda","vencimento","ingrediente_ativo"].includes(field)?value:parseFloat(String(value).replace(",","."))||0; return nd; });
  }
  ...
  function addProd(catIdx) {
    ...
    setData(d=>{ const nd=JSON.parse(JSON.stringify(d));
      nd[activeCult].categories[catIdx].products.push({...newProd,dose:parseFloat(String(newProd.dose).replace(",","."))||0,area:parseFloat(String(newProd.area).replace(",","."))||nd[activeCult].area,preco_unit:parseFloat(String(newProd.preco_unit).replace(",","."))||0,preco_compra:null,fornecedor_compra:null});
      return nd; });
    setNewProd({produto:"",dose:"",area:"",fase:"",obs:"",preco_unit:"",ingrediente_ativo:"",revenda:"",vencimento:""});
    setAddingTo(null);
  }

  const EC = ({catIdx,prodIdx,field,type="text",value,raw}) => {
    const editVal = raw!==undefined ? (raw==null||raw===""?"":String(raw).replace(".",",")) : value;
    const isEd=editingCell?.catIdx===catIdx&&editingCell?.prodIdx===prodIdx&&editingCell?.field===field;
    const [localVal,setLocalVal] = useState(editVal);
    const prevIsEd = useRef(false);
    useEffect(()=>{
      // Só sincroniza o valor local quando o campo ABRE para edição (transição false->true)
      if(isEd && !prevIsEd.current) setLocalVal(editVal);
      prevIsEd.current = isEd;
    },[isEd]);
    if(isEd) return <input autoFocus type={type==="number"?"text":type} inputMode={type==="number"?"decimal":undefined} value={localVal??""} step="any"
      style={{width:"100%",padding:"2px 5px",fontSize:11,border:"2px solid "+colors.badge,borderRadius:3,background:colors.light}}
      onChange={e=>setLocalVal(e.target.value)}
      onBlur={()=>{updField(catIdx,prodIdx,field,localVal);setEditingCell(null);}}
      onKeyDown={e=>{if(e.key==="Enter"){updField(catIdx,prodIdx,field,localVal);setEditingCell(null);}if(e.key==="Escape")setEditingCell(null);}}/>;
    return <span onClick={()=>{setLocalVal(editVal);setEditingCell({catIdx,prodIdx,field});}} style={{cursor:"pointer",display:"block",minWidth:30}}>{value||<span style={{color:"#ccc"}}>—</span>}<span style={{fontSize:8,color:"#bbb",marginLeft:2}}>✏</span></span>;
  };
  ...
  return (
    <div style={{maxWidth:1100,margin:"0 auto",padding:14}}>
      ...
      <div style={{background:"#fff",borderRadius:10,padding:"12px 16px",marginBottom:12,display:"flex",alignItems:"center",gap:14,boxShadow:"0 1px 4px rgba(0,0,0,0.08)",flexWrap:"wrap"}}>
        ...
        <div style={{borderLeft:"1px solid #eee",paddingLeft:14}}>
          <div style={{fontSize:11,color:"#888"}}>kg/ha semente</div>
          {editingKgSem
            ?<input autoFocus type="number" defaultValue={culture.kgSemente||0} step="1"
                style={{fontSize:16,fontWeight:700,color:colors.bg,border:"2px solid "+colors.badge,borderRadius:4,width:70,padding:"2px 5px"}}
                onBlur={e=>{setData(d=>{const nd=JSON.parse(JSON.stringify(d));nd[activeCult].kgSemente=parseFloat(e.target.value)||0;return nd;});setEditingKgSem(false);}}
                onKeyDown={e=>{if(e.key==="Enter")e.target.blur();}}/>
            :<div style={{fontSize:17,fontWeight:700,color:colors.bg,cursor:"pointer"}} onClick={()=>setEditingKgSem(true)}>{culture.kgSemente||0} kg ✏</div>
          }
        </div>
        ...
        <div style={{marginLeft:"auto",display:"flex",gap:6}}>
          ...
          <button onClick={()=>{const nome=window.prompt("Nome da nova cultura:");if(!nome) return;setData(d=>{const nd=JSON.parse(JSON.stringify(d));nd[nome]={area:0,ativo:true,op_costs:{},categories:[{name:"Adubação",products:[]},{name:"Sementes",products:[]},{name:"Tratamento de Sementes",products:[]},{name:"Fungicidas",products:[]},{name:"Inseticidas",products:[]},{name:"Foliares",products:[]}]};return nd;});}}
                ...
                <table style={{width:"100%",borderCollapse:"collapse",fontSize:11}}>
                  <thead>
                    <tr style={{background:colors.light}}>
                      <th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Produto</th>
                      {["Herbicidas","Fungicidas","Inseticidas","Dessecação"].includes(cat.name)&&<th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>I.A.</th>}
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Dose</th>
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Área</th>
                      {cat.name==="Tratamento de Sementes"&&<th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>kg/ha</th>}
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Qtd</th>
                      <th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Fase</th>
                      <th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Obs</th>
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Ref.(R$)</th>
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Compra(R$)</th>
                      <th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Fornecedor</th>
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Total</th>
                      <th style={{padding:"5px 7px",textAlign:"right",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>R$/ha</th>
                      <th style={{padding:"5px 7px",textAlign:"left",color:colors.accent,fontSize:9,letterSpacing:1,textTransform:"uppercase",whiteSpace:"nowrap"}}>Venc.</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    {cat.products.map((p,pi)=>{
                      ...
                      const isSemente=(p.produto||"").toLowerCase().includes("sement");
                      const kgHaVal=parseFloat(p.kgHa||culture.kgSemente||0);
                      const qtdTS=p.dose>0?p.dose*kgHaVal*p.area/100:kgHaVal*p.area/100;
                      const qtdGeral=p.qtd!=null?p.qtd:(p.dose>0?p.dose*p.area:p.area);
                      const total=cat.name==="Tratamento de Sementes"&&!isSemente ? qtdTS*preco : (p.dose>0?p.dose*p.area*preco:p.area*preco);
                      ...
                      return (
                        <tr key={pi} style={{background:bg}}>
                          ...
                          {["Herbicidas","Fungicidas","Inseticidas","Dessecação"].includes(cat.name)&&<td style={{padding:"5px 7px",color:"#888",fontSize:10}}><EC catIdx={catIdx} prodIdx={pi} field="ingrediente_ativo" value={p.ingrediente_ativo||""}/></td>}
                          <td style={{padding:"5px 7px",textAlign:"right"}}><EC catIdx={catIdx} prodIdx={pi} field="dose" type="number" value={fmtNum(p.dose)} raw={p.dose}/></td>
                          <td style={{padding:"5px 7px",textAlign:"right"}}><EC catIdx={catIdx} prodIdx={pi} field="area" type="number" value={fmtNum(p.area)}/></td>
                          {cat.name==="Tratamento de Sementes"&&(
                            <td style={{padding:"5px 7px",textAlign:"right"}}><EC catIdx={catIdx} prodIdx={pi} field="kgHa" type="number" value={fmtNum(kgHaVal)}/></td>
                          )}
                          <td style={{padding:"5px 7px",textAlign:"right",color:"#555"}}>
                            {cat.name==="Tratamento de Sementes"&&!isSemente
                              ? <span style={{fontWeight:600,color:"#1a5c2e"}}>{fmtNum(qtdTS)}</span>
                              : <EC catIdx={catIdx} prodIdx={pi} field="qtd" type="number" value={fmtNum(qtdGeral)}/>
                            }
                          </td>
                          <td style={{padding:"5px 7px"}}><EC catIdx={catIdx} prodIdx={pi} field="fase" value={p.fase||""}/></td>
                          <td style={{padding:"5px 7px",color:"#888"}}><EC catIdx={catIdx} prodIdx={pi} field="obs" value={p.obs||""}/></td>
                          <td style={{padding:"5px 7px",textAlign:"right",color:"#999",textDecoration:comprado?"line-through":""}}>{fmtR2(p.preco_unit)}</td>
                          <td style={{padding:"5px 7px",textAlign:"right",fontWeight:comprado?700:400,color:comprado?"#2e7d32":"#bbb"}}><EC catIdx={catIdx} prodIdx={pi} field="preco_compra" type="number" value={p.preco_compra!=null?fmtNum(p.preco_compra):""}/></td>
                          <td style={{padding:"5px 7px",fontSize:10,color:"#2e7d32"}}><EC catIdx={catIdx} prodIdx={pi} field="fornecedor_compra" value={p.fornecedor_compra||""}/></td>
                    ...
                    {addingTo?.catIdx===catIdx?(
                      <tr style={{background:"#fffde7"}}>
                        {["produto",...(["Herbicidas","Fungicidas","Inseticidas","Dessecação"].includes(cat.name)?["ingrediente_ativo"]:[]),"dose","area",...(cat.name==="Tratamento de Sementes"?["kgHa"]:[]),null,"fase","obs","preco_unit",null,null,null,null,"vencimento"].map((field,i)=>(
                          <td key={i} style={{padding:"3px 5px"}}>
                            {field?<input placeholder={field} type={["dose","area","preco_unit","kgHa"].includes(field)?"number":"text"} step="any"
                      ...
                      <tr><td colSpan={14} style={{padding:"4px 8px"}}>
                        <button onClick={()=>{setAddingTo({catIdx});setNewProd({produto:"",dose:"",area:culture.area,fase:"",obs:"",preco_unit:"",ingrediente_ativo:"",vencimento:""});}}
...
// ── gerarDocCotacao ───────────────────────────────────────────────────────────
function gerarDocCotacao(tipo, tipoLabel, safraLabel, produtos, allPrices, fornecedores) {
  const fmtR2 = v => v!=null ? "R$ "+Number(v).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}) : "—";
  ...
  let html = `<html><head><meta charset="utf-8"/><style>
    ...
    h1{color:#1a3a1a;font-size:14pt;margin-bottom:4px}
    h2{color:#2e7d32;font-size:11pt;margin:16px 0 4px;border-bottom:1px solid #2e7d32;padding-bottom:2px}
    h3{color:#555;font-size:10pt;margin:10px 0 4px}
    table{border-collapse:collapse;width:100%;margin-bottom:8px;font-size:9pt}
    th{background:#1a3a1a;color:#fff;padding:4px 7px;text-align:left}
    td{padding:3px 7px;border-bottom:1px solid #ddd}
    tr:nth-child(even) td{background:#f5f9f5}
    .melhor{background:#e8f5e9!important;font-weight:bold;color:#2e7d32}
    .economia{color:#2e7d32;font-weight:bold}
    .sub{color:#888;font-size:8pt}
  </style></head><body>`;

  html += `<h1>📋 GC Agro — Cotação de ${tipoLabel} · ${safraLabel}</h1>`;
  html += `<p class="sub">Gerado em ${dt} · ${produtos.length} produtos · ${fornecedores.length} fornecedores</p>`;

  if (tipo === "sem") {
    // Sementes: mostrar tabela por fornecedor
    html += `<h2>🌾 Cotação de Sementes</h2>`;
    fornecedores.forEach(f => {
      const pr = allPrices[f.nome] || {};
      const rows = [];
      for (let i = 0; i < 12; i++) {
        const nome = pr[`sem_${i}_nome`];
        if (!nome) continue;
        const cult = pr[`sem_${i}_cult`] || "—";
        const area = pr[`sem_${i}_area`] || "—";
        const pop  = pr[`sem_${i}_pop`]  || "—";
        const preco= pr[`sem_${i}_preco`]|| "";
        const semPorBag = cult==="Soja"?5000000:cult==="Feijão"?3500000:60000;
        const unid = cult==="Milho"?"sc":"bag";
        const qtd  = parseFloat(area)>0&&parseFloat(pop)>0 ? ((parseFloat(area)*(parseFloat(pop)*1000))/semPorBag).toFixed(1)+" "+unid : "—";
        rows.push({nome,cult,area,pop,qtd,preco});
      }
      if (!rows.length) return;
      html += `<h3>${f.nome}</h3><table><tr><th>Variedade</th><th>Cultura</th><th>Área(ha)</th><th>Pop(mil/ha)</th><th>Qtd</th><th>R$/bag</th></tr>`;
      rows.forEach(r => {
        html += `<tr><td>${r.nome}</td><td>${r.cult}</td><td>${r.area}</td><td>${r.pop}</td><td>${r.qtd}</td><td>${r.preco?fmtR2(r.preco):"—"}</td></tr>`;
      });
      html += `</table>`;
    });
  } else {
    // Adubação / Insumos: tabela comparativa por categoria
    const categorias = [...new Set(produtos.map(p => p.categoria))];
    categorias.forEach(cat => {
      const prods = produtos.filter(p => p.categoria === cat);
      if (!prods.length) return;
      html += `<h2>${cat}</h2>`;
      html += `<table><tr><th>Produto</th><th>I.A.</th><th>Unid.</th><th>Qtd.</th><th>Ref.</th>`;
      fornecedores.forEach(f => { html += `<th>${f.nome.split(" ")[0]}</th>`; });
      html += `<th>✔ Melhor</th><th>Economia</th></tr>`;
      prods.forEach(p => {
        ...
        const melhor  = validos.length ? Math.min(...validos) : null;
        const eco     = melhor !== null ? (p.preco_ref - melhor) * p.qtd_total : null;
        html += `<tr><td>${p.nome}</td><td class="sub">${p.ingrediente_ativo||"—"}</td><td>${p.unidade}</td><td>${fmtN(p.qtd_total)}</td><td>${fmtR2(p.preco_ref)}</td>`;
        fp.forEach((v, fi) => {
          const isBest = v !== null && v === melhor;
          html += `<td class="${isBest?"melhor":""}">${v!==null?fmtR2(v):"—"}</td>`;
        });
        html += `<td class="melhor">${melhor!==null?fmtR2(melhor):"—"}</td>`;
        html += `<td class="${eco>0?"economia":""}">${eco!==null?(eco>=0?"+":"")+fmtR2(eco):"—"}</td>`;
        html += `</tr>`;
      });
      html += `</table>`;
    });
    ...
    html += `<h2>📊 Resumo por Fornecedor</h2>`;
    html += `<table><tr><th>Fornecedor</th><th>Produtos cotados</th><th>Total cotado</th></tr>`;
    fornecedores.forEach(f => {
      const pr = allPrices[f.nome] || {};
      ...
      html += `<tr><td>${f.nome}</td><td>${count}/${produtos.length}</td><td>${total>0?fmtR2(total):"—"}</td></tr>`;
    });
    html += `</table>`;
  }
            ...
            {categorias.filter(cat=>filterCat==="Todas"||cat===filterCat).map(cat=>{
              ...
              return (
                <div key={cat} style={{marginBottom:18}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 60px 100px 120px 160px 140px",gap:1,background:"#1e3a5f22"}}>
                    {["Produto","Unid.","Qtd.","I.A. (editável)","Nome Comercial","Preço (R$)"].map(h=>(
                      <div key={h} style={{padding:"6px 9px",background:"#111d35",fontSize:9,color:"#5a7a9a",letterSpacing:1,textTransform:"uppercase"}}>{h}</div>
                    ))}
                    {prods.map((p,ii)=>{
                      const key=p.nome.toLowerCase();
                      const kNome=key+"_nome";
                      const kIA=key+"_ia";
                      const val=myPrices[key]!==undefined?myPrices[key]:"";
                      const nomeComercial=myPrices[kNome]||"";
                      // Auto-fill IA from product data if not yet set
                      const iaAtual=myPrices[kIA]!==undefined?myPrices[kIA]:(p.ingrediente_ativo||"");
                      ...
                      return (
                        <React.Fragment key={key}>
                          ...
                          <div style={{padding:"4px 6px",background:bg}}>
                            <input type="text" value={iaAtual}
                              onChange={e=>setMyPrices(prev=>({...prev,[kIA]:e.target.value}))}
                              placeholder={p.ingrediente_ativo||"I.A."}
                              style={{width:"100%",padding:"5px 8px",background:"#0a1628",border:"1px solid #1e3a5f",borderRadius:4,color:iaAtual?p.ingrediente_ativo===iaAtual?"#5a7a9a":"#fbbf24":"#5a7a9a",fontSize:10,outline:"none",boxSizing:"border-box"}}/>
                          </div>
                          <div style={{padding:"4px 6px",background:bg}}>
                            <input type="text" value={nomeComercial}
                              onChange={e=>setMyPrices(prev=>({...prev,[kNome]:e.target.value}))}
                              placeholder="Ex: Lawyer, Liberty..."
                              style={{width:"100%",padding:"5px 8px",background:"#0a1628",border:"1px solid #1e3a5f",borderRadius:4,color:"#e8f4fd",fontSize:11,outline:"none",boxSizing:"border-box"}}/>
                          </div>
                          <div style={{padding:"4px 6px",background:bg}}>
      ...
      <div style={{background:"#0a1628",minHeight:"calc(100vh - 48px)",color:"#e8f4fd"}}>
        <div style={{background:"#111d35",borderBottom:"1px solid #1e3a5f",padding:"10px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:8}}>
          ...
          <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
            ...
            <button onClick={()=>gerarDocCotacao(tipo,tipoLabel,safraLabel,produtos,allPrices,fornecedores)} style={{padding:"8px 14px",background:"#5c3a8a",border:"none",borderRadius:6,color:"#fff",fontSize:11,fontWeight:700,cursor:"pointer"}}>📄 Gerar Cotação</button>
        ...
        {adminTab==="merit"&&tipo==="sem"&&(
          <div style={{padding:"14px 18px 40px"}}>
            <div style={{fontSize:11,color:"#7a9ab8",marginBottom:14}}>Respostas dos fornecedores para cotação de sementes:</div>
            {fornecedores.map(f=>{
              const pr=allPrices[f.nome]||{};
              const rows=[];
              for(let i=0;i<12;i++){
                const nome=pr[`sem_${i}_nome`];
                if(!nome) continue;
                const cult=pr[`sem_${i}_cult`]||"Soja";
                const area=parseFloat(pr[`sem_${i}_area`])||0;
                const pop=parseFloat(pr[`sem_${i}_pop`])||0;
                const preco=pr[`sem_${i}_preco`]||0;
                const semPorBag=cult==="Soja"?5000000:cult==="Feijão"?3500000:60000;
                const unid=cult==="Milho"?"sc":"bag";
                const qtd=area>0&&pop>0?((area*(pop*1000))/semPorBag).toFixed(1)+" "+unid:"—";
                rows.push({nome,cult,area,pop,qtd,preco});
              }
              const count=rows.length;
              return(
                <div key={f.nome} style={{background:"#111d35",borderRadius:10,border:"1px solid #1e3a5f",marginBottom:14,overflow:"hidden"}}>
                  <div style={{background:"#1e3a5f",padding:"8px 14px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    <div style={{fontSize:13,fontWeight:700,color:"#e8f4fd"}}>{f.nome}</div>
                    <div style={{fontSize:10,color:count>0?"#4ade80":"#5a7a9a"}}>{count>0?`${count} variedades cotadas`:"Sem resposta"}</div>
                  </div>
                  {count===0?<div style={{padding:"12px 14px",fontSize:11,color:"#5a7a9a"}}>Nenhuma entrada ainda.</div>:(
                    <table style={{width:"100%",borderCollapse:"collapse",fontSize:10}}>
                      <thead><tr style={{background:"#0d1e36"}}>
                        {["Variedade","Cultura","Área(ha)","Pop(mil/ha)","Qtd calc.","R$/bag"].map(h=>(
                          <th key={h} style={{padding:"5px 9px",color:"#5a7a9a",textAlign:"left",fontSize:9,textTransform:"uppercase"}}>{h}</th>
                        ))}
                      </tr></thead>
                      <tbody>
                        {rows.map((r,i)=>(
                          <tr key={i} style={{background:i%2===0?"#0d1e36":"#111d35"}}>
                            <td style={{padding:"5px 9px",color:"#d0e8ff",fontWeight:600}}>{r.nome}</td>
                            <td style={{padding:"5px 9px",color:"#7a9ab8"}}>{r.cult}</td>
                            <td style={{padding:"5px 9px",color:"#7a9ab8",textAlign:"right"}}>{r.area||"—"}</td>
                            <td style={{padding:"5px 9px",color:"#7a9ab8",textAlign:"right"}}>{r.pop||"—"}</td>
                            <td style={{padding:"5px 9px",color:"#4ade80",fontWeight:700,textAlign:"right"}}>{r.qtd}</td>
                            <td style={{padding:"5px 9px",color:r.preco>0?"#4a9eff":"#5a7a9a",fontWeight:r.preco>0?700:400,textAlign:"right"}}>{r.preco>0?"R$ "+Number(r.preco).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2}):"—"}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                        ...
                        {prods.map((p,ri)=>{
                          ...
                          return (
                            <tr key={key}>
                              ...
                              {fp.map((v,fi)=>{
                                const isBest=v!==null&&v===melhor;
                                const fName=fornecedores[fi].nome;
                                return(
                                <td key={fi} style={{padding:"3px 6px",background:isBest?"#0d2a1a":bg,textAlign:"right"}}>
                                  <input
                                    type="number"
                                    step="0.01"
                                    value={v!==null?v:""}
                                    onChange={e=>{
                                      ...
                                      setAllPrices(prev=>({...prev,[fName]:{...(prev[fName]||{}),[key]:val}}));
                                    }}
                                    style={{
                                      width:80,padding:"3px 5px",fontSize:10,textAlign:"right",
                                      background:"transparent",
                                      border:isBest?"1px solid #4ade80":"1px solid #1e3a5f",
                                      borderRadius:4,
                                      color:isBest?"#4ade80":v!==null?"#e8f4fd":"#3a5a7a",
...
function FecharCotacaoModal({produtos, allPrices, fornecedores, onConfirm, onCancel, fmtR2}) {
  const [decisions, setDecisions] = useState(()=>{
    ...
    produtos.forEach(p=>{
      const key=p.nome.toLowerCase();
      const vals=fornecedores.map(f=>{
        const pr=(allPrices[f.nome]||{});
        return {nome:f.nome, preco:pr[key]||0, nomeComercial:pr[key+"_nome"]||""};
      }).filter(x=>x.preco>0);
      const melhor=vals.length?vals.reduce((a,b)=>a.preco<b.preco?a:b):null;
      const nomeComercialVencedor=melhor?.nomeComercial||p.nome;
      const iaVencedor=melhor?((allPrices[melhor.nome]||{})[key+"_ia"]||p.ingrediente_ativo||""):(p.ingrediente_ativo||"");
      d[key]={nomeReal:nomeComercialVencedor,iaReal:iaVencedor,splits:melhor?[{nome:melhor.nome,qtd:100,preco:melhor.preco}]:[{nome:"",qtd:100,preco:0}]};
    });
    return d;
  });
...
// MAIN APP
// ═══════════════════════════════════════════════════════════════════════════
function SaveButton({dataVerao, dataSafrinha}) {
  ...
  const bg = status==="saved" ? "#2e7d32" : status==="saving" ? "#1565C0" : "rgba(255,255,255,0.15)";
  const label = status==="saved" ? "✓ Salvo!" : status==="saving" ? "Salvando..." : "💾 Salvar";
  return (
    <button onClick={handleSave} disabled={status!=="idle"}
      style={{padding:"6px 10px",background:bg,border:"none",borderRadius:5,color:"#fff",fontSize:10,cursor:status==="idle"?"pointer":"default",transition:"background 0.3s"}}>
      {label}
    </button>
  );
}
...
function App() {
  // ── Core data ──
  const [dataVerao,   setDataVerao]   = useState(() => migrateCats(ls.get(KEYS.safraVerao,   INITIAL_DATA_VERAO)));
  const [dataSafrinha, setDataSafrinha] = useState(() => migrateCats(ls.get(KEYS.safraSafrinha, INITIAL_DATA_INVERNO)));
  ...
  function onImport(backup) {
    if(backup.dataVerao) setDataVerao(migrateCats(backup.dataVerao));
    if(backup.dataSafrinha) setDataSafrinha(migrateCats(backup.dataSafrinha));
  ...
  return (
    <div style={{minHeight:"100vh",background:"#f0f4f8",fontFamily:"system-ui,sans-serif",position:"relative"}}>
      ...
      <div style={{background:"#1a5c2e",color:"#fff",position:"sticky",top:0,zIndex:200,boxShadow:"0 2px 8px rgba(0,0,0,0.25)"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 12px",height:50}}>
          ...
          <div style={{display:"flex",gap:6,alignItems:"center"}}>
            ...
            <SaveButton dataVerao={dataVerao} dataSafrinha={dataSafrinha} />
          </div>
        </div>
      </div>
      ...
      {/* ── VIEWS ── */}
      {view==="prog_verao"    && <ProgView data={dataVerao}    setData={setDataVerao}    tipo="verao" onGerarCotacao={(tipo)=>{if(tipo==="adub")setView("cot_v_adub");else setView("cot_v_ins");}}/>}
      {view==="prog_safrinha" && <ProgView data={dataSafrinha} setData={setDataSafrinha} tipo="safrinha" onGerarCotacao={(tipo)=>{if(tipo==="adub")setView("cot_s_adub");else setView("cot_s_ins");}}/>}
